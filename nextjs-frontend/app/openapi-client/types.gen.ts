...
export type AskConformixRequest = {
  query: string;
...
export type AskConformixData = {
  body: AskConformixRequest;
};

export type AskConformixResponse = string;

export type AskConformixError = HTTPValidationError;
